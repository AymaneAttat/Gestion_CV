                    ...
                    <div class="card-body row">
                        <div class="col-md-4 position-relative">
                            <div class="info-horizontal bg-gradient-primary border-radius-xl d-block d-md-flex p-4">
                                ...
                                <div class="ps-0 ps-md-3 mt-3 mt-md-0">
                                    <router-link :to="{name: 'profiles.index'}" class="text-white"><h5 class="text-white">Profiles</h5></router-link>
                        ...
                        <div class="col-md-4 position-relative">
                            <div class="info-horizontal bg-gradient-primary border-radius-xl d-block d-md-flex p-4">
                                ...
                                <div class="ps-0 ps-md-3 mt-3 mt-md-0">
                                    <h5 class="text-white"><router-link :to="{name: 'skills.index'}" class="text-white icon-move-right">Compétences</router-link></h5>
                        ...
                        <div class="col-md-4">
                            <div class="info-horizontal bg-gradient-primary border-radius-xl d-block d-md-flex p-4">
                                ...
                                <div class="ps-0 ps-md-3 mt-3 mt-md-0">
                                    <h5 class="text-white">Historique</h5>
