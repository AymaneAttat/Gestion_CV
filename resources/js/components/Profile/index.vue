    ...
    <div>
        ...
        <div class="card card-body shadow-xl mx-3 mx-md-4 mt-n6">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <button type="button" class="btn bg-gradient-primary" data-bs-toggle="modal" data-bs-target="#exampleModal1"><b-icon icon="cloud-upload" aria-hidden="true"></b-icon> Insérer des CV</button>
                    </div>
                    <div class="col d-flex justify-content-end">
                        <button type="button" class="btn bg-gradient-primary w-auto me-2" data-bs-toggle="modal" data-bs-target="#exampleModalProfile"><b-icon icon="cloud-upload" aria-hidden="true"></b-icon> Des Profiles</button>
                    </div>
                </div>
