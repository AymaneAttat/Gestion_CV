                    ...
                    <table class="table table-hover table-sm">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td scope="row"><small>{{ prof.skill1 }}</small></td>
                                <td scope="row"><small>{{ prof.skill2 }}</small></td>
                                <td scope="row"><small>{{ prof.skill3 }}</small></td>
                                <td scope="row"><small>{{ prof.skill4 }}</small></td>
                                <td scope="row"><small>{{ prof.skill5 }}</small></td>
